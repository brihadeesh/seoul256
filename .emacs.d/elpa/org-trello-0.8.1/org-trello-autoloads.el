...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello" '("org-trello")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-action" '("orgtrello-action-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-api" '("orgtrello-api-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-backend" '("orgtrello-backend-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-buffer" '("orgtrello-buffer-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-cbx" '("orgtrello-cbx-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-controller" '("orgtrello-controller-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-data" '("orgtrello-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-date" '("orgtrello-date-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-deferred" '("orgtrello-deferred-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-entity" '("orgtrello-entity-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-hash" '("orgtrello-hash-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-input" '("orgtrello-input-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-log" '("orgtrello-log-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-proxy" '("orgtrello-proxy-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-query" '("orgtrello-query-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-setup" '("org" "*org-trello-interactive-command-binding-couples*" "*ORGTRELLO/MODE-PREFIX-KEYBINDING*")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-utils" '("orgtrello-utils-")))
